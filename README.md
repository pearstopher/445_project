...
```shell
python convert.py models/examples/samples500_hidden400_epoch50.npz audio/examples/square.wav
```
...
```shell
python convert.py models/examples/samples500_hidden400_epoch50.npz audio/examples/10s.wav
...
be, just accounting for the work which I have accomplished so far! This seems like a
good sign that I have probably done enough for now. However, this project is something
